...
* WORK
** last time
- working on the template environment for the microservice

** was out friday and yesterday moving; been stuck dealing with the move for the past few days.

** today
continue working on the template for microservice and keep moving ahead towards the
sprint goals

- did do the demo/overview of the architecture the other day.
- I have this next one a week from this thursday.
